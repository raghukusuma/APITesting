...
# get,post,put,patch,del all did at a place with global varialbe and tokens collectn from
# one place and using them at other place
...
def test_partial_update_current_booking ():
   ...
   # resource_endpoint = 'https://restful-booker.herokuapp.com/booking/1'
    ...
    file = open('C:\\Users\\rkusuma\\Desktop\\API\\partial_update_booking.json', 'r')
    data = json.loads(file.read())
    print(data)
    response = requests.patch(resource_endpoint, headers=headers, json=data)
    print(response)
    print(response.text)
...
# delete booking
def test_delete_bookings_on_id2 ():
    ...
    #this has no body so body data no need
    response = requests.delete(resource_endpoint, headers=headers)
    print(response)
    print(response.text)

# get function aftr deleting resource

def test_get_aftr_del_bookings_on_id2 ():
    #resource_endpoint = 'https://restful-booker.herokuapp.com/booking/' +str(json_response[1])
    resource_endpoint = 'https://restful-booker.herokuapp.com/booking/'+ str(id2)
    response = requests.get(resource_endpoint)
    print(response.text)